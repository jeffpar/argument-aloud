---
title: Chief Justice Edward White
layout: pane
justice_id: edward_white
wikipedia_url: https://en.wikipedia.org/wiki/Edward_Douglass_White
years_served: 27.2
days_served: "9,930"
opinions: 725
lone_dissents: 33
...
<h1>{{ page.title }}</h1>
<p>Born November 3, 1845. Died May 19, 1921.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller11">March 12, 1894</a> to <a href="/courts/ussc/?collection=benches&id=white9">May 19, 1921</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
