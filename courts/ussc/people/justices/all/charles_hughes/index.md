---
title: Chief Justice Charles Hughes
layout: pane
justice_id: charles_hughes
wikipedia_url: https://en.wikipedia.org/wiki/Charles_Evans_Hughes
years_served: 17.0
days_served: "6,216"
opinions: 403
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born April 11, 1862. Died August 27, 1948.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller24">October 10, 1910</a> to June 10, 1916 and from February 24, 1930 to <a href="/courts/ussc/?collection=benches&id=hughes14">June 30, 1941</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
