...
<h1>{{ page.title }}</h1>
<p>Served from October 10, 1910 to June 10, 1916 and from February 24, 1930 to June 30, 1941{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% endif %}.</p>
