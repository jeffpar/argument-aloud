---
title: Justice Alfred Moore
layout: pane
justice_id: alfred_moore
wikipedia_url: https://en.wikipedia.org/wiki/Alfred_Moore
years_served: 3.8
days_served: "1,376"
---
...
<h1>{{ page.title }}</h1>
<p>Born May 21, 1755. Died October 15, 1810.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=ellsworth4">April 21, 1800</a> to <a href="/courts/ussc/?collection=benches&id=marshall1">January 26, 1804</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
