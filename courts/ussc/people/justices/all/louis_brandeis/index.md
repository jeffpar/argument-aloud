---
title: Justice Louis Brandeis
layout: pane
justice_id: louis_brandeis
...
<h1>{{ page.title }}</h1>
<p>Born November 13, 1856. Died October 5, 1941.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=white7">June 5, 1916</a> to <a href="/courts/ussc/?collection=benches&id=hughes9">February 13, 1939</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
