...
layout: pane
justice_id: horace_lurton
wikipedia_url: https://en.wikipedia.org/wiki/Horace_Lurton
years_served: 4.5
days_served: "1,652"
opinions: 98
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Born February 26, 1844. Died July 12, 1914.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller22">January 3, 1910</a> to <a href="/courts/ussc/?collection=benches&id=white4">July 12, 1914</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
