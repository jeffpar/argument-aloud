...
layout: pane
justice_id: john_marshall
wikipedia_url: https://en.wikipedia.org/wiki/John_Marshall
years_served: 34.4
days_served: "12,571"
opinions: 536
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born September 24, 1755. Died July 6, 1835.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall1">February 4, 1801</a> to <a href="/courts/ussc/?collection=benches&id=marshall15">July 6, 1835</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
