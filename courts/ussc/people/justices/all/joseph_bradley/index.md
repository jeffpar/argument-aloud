---
title: Justice Joseph Bradley
layout: pane
justice_id: joseph_bradley
wikipedia_url: https://en.wikipedia.org/wiki/Joseph_P._Bradley
years_served: 21.8
days_served: "7,976"
opinions: 400
lone_dissents: 36
...
<h1>{{ page.title }}</h1>
<p>Born March 14, 1813. Died January 22, 1892.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=chase6">March 23, 1870</a> to <a href="/courts/ussc/?collection=benches&id=fuller5">January 22, 1892</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
