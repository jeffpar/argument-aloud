---
title: Justice Robert Grier
layout: pane
justice_id: robert_grier
...
<h1>{{ page.title }}</h1>
<p>Born March 5, 1794. Died September 25, 1870.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney9">August 10, 1846</a> to <a href="/courts/ussc/?collection=benches&id=chase3">January 31, 1870</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
