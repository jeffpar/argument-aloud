---
title: Justice John Campbell
layout: pane
justice_id: john_campbell
wikipedia_url: https://en.wikipedia.org/wiki/John_Archibald_Campbell
years_served: 8.1
days_served: "2,942"
opinions: 92
lone_dissents: 6
...
<h1>{{ page.title }}</h1>
<p>Born June 24, 1811. Died March 12, 1889.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney12">April 11, 1853</a> to <a href="/courts/ussc/?collection=benches&id=taney15">April 30, 1861</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
