...
<h1>{{ page.title }}</h1>
<p>Served from April 11, 1853 to April 30, 1861{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% endif %}.</p>
