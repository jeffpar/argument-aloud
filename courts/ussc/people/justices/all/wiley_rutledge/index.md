---
title: Justice Wiley Rutledge
layout: pane
justice_id: wiley_rutledge
wikipedia_url: https://en.wikipedia.org/wiki/Wiley_Blount_Rutledge
years_served: 6.6
days_served: "2,400"
opinions: 65
lone_dissents: 7
...
<h1>{{ page.title }}</h1>
<p>Born July 20, 1894. Died September 10, 1949.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=stone3">February 15, 1943</a> to <a href="/courts/ussc/?collection=benches&id=vinson1">September 10, 1949</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
