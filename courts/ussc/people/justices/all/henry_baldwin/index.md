---
title: Justice Henry Baldwin
layout: pane
justice_id: henry_baldwin
wikipedia_url: https://en.wikipedia.org/wiki/Henry_Baldwin_(judge)
years_served: 14.3
days_served: "5,208"
opinions: 40
lone_dissents: 31
...
<h1>{{ page.title }}</h1>
<p>Born January 14, 1780. Died April 21, 1844.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall13">January 18, 1830</a> to <a href="/courts/ussc/?collection=benches&id=taney5">April 21, 1844</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
