---
title: Chief Justice William Rehnquist
layout: pane
justice_id: william_rehnquist
wikipedia_url: https://en.wikipedia.org/wiki/William_Rehnquist
years_served: 33.7
days_served: "12,294"
opinions: 456
lone_dissents: 76
...
<h1>{{ page.title }}</h1>
<p>Born October 1, 1924. Died September 3, 2005.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=burger4">January 7, 1972</a> to <a href="/courts/ussc/?collection=benches&id=rehnquist9">September 3, 2005</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
