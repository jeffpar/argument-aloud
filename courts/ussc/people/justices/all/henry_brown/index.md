---
title: Justice Henry Brown
layout: pane
justice_id: henry_brown
wikipedia_url: https://en.wikipedia.org/wiki/Henry_Billings_Brown
years_served: 15.4
days_served: "5,622"
opinions: 455
lone_dissents: 18
...
<h1>{{ page.title }}</h1>
<p>Born March 2, 1836. Died September 4, 1913.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller5">January 5, 1891</a> to <a href="/courts/ussc/?collection=benches&id=fuller18">May 28, 1906</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
