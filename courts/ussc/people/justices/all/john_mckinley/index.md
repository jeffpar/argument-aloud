...
<h1>{{ page.title }}</h1>
<p>Born May 1, 1780. Died July 19, 1852.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney2">April 22, 1837</a> to <a href="/courts/ussc/?collection=benches&id=taney10">July 19, 1852</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
