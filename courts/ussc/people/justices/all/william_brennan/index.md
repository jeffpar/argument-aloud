---
title: Justice William Brennan
layout: pane
justice_id: william_brennan
wikipedia_url: https://en.wikipedia.org/wiki/William_J._Brennan_Jr.
years_served: 33.8
days_served: "12,331"
opinions: 452
lone_dissents: 20
...
<h1>{{ page.title }}</h1>
<p>Born April 25, 1906. Died July 24, 1997.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren4">October 16, 1956</a> to <a href="/courts/ussc/?collection=benches&id=rehnquist3">July 20, 1990</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
