---
title: Justice Gabriel Duvall
layout: pane
justice_id: gabriel_duvall
wikipedia_url: https://en.wikipedia.org/wiki/Gabriel_Duval
years_served: 23.1
days_served: "8,454"
opinions: 15
lone_dissents: 3
...
<h1>{{ page.title }}</h1>
<p>Born December 6, 1752. Died March 6, 1844.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall6">November 23, 1811</a> to <a href="/courts/ussc/?collection=benches&id=marshall14">January 14, 1835</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
