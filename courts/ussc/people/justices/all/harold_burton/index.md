...
<h1>{{ page.title }}</h1>
<p>Born June 22, 1888. Died October 28, 1964.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=stone4">October 1, 1945</a> to <a href="/courts/ussc/?collection=benches&id=warren6">October 13, 1958</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
