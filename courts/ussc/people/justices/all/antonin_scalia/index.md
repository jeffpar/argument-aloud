...
wikipedia_url: https://en.wikipedia.org/wiki/Antonin_Scalia
years_served: 29.4
days_served: "10,733"
opinions: 282
lone_dissents: 19
...
<h1>{{ page.title }}</h1>
<p>Born March 11, 1936. Died February 13, 2016.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rehnquist1">September 26, 1986</a> to <a href="/courts/ussc/?collection=benches&id=roberts4">February 13, 2016</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
