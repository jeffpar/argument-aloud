---
title: Justice David Brewer
layout: pane
justice_id: david_brewer
...
<h1>{{ page.title }}</h1>
<p>Born June 20, 1837. Died March 28, 1910.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller3">January 6, 1890</a> to <a href="/courts/ussc/?collection=benches&id=fuller22">March 28, 1910</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
