---
title: Justice Robert Trimble
layout: pane
justice_id: robert_trimble
wikipedia_url: https://en.wikipedia.org/wiki/Robert_Trimble
years_served: 2.2
days_served: "802"
opinions: 15
---
...
<h1>{{ page.title }}</h1>
<p>Born November 17, 1776. Died August 25, 1828.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall10">June 16, 1826</a> to <a href="/courts/ussc/?collection=benches&id=marshall10">August 25, 1828</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
