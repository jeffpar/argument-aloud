---
title: Justice James Wayne
layout: pane
justice_id: james_wayne
wikipedia_url: https://en.wikipedia.org/wiki/James_Moore_Wayne
years_served: 32.5
days_served: "11,861"
opinions: 146
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall15">January 14, 1835</a> to <a href="/courts/ussc/?collection=benches&id=chase2">July 5, 1867</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
