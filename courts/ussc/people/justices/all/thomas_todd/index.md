---
title: Justice Thomas Todd
layout: pane
justice_id: thomas_todd
wikipedia_url: https://en.wikipedia.org/wiki/Thomas_Todd
years_served: 18.8
days_served: "6,855"
opinions: 13
---
...
<h1>{{ page.title }}</h1>
<p>Born January 23, 1765. Died February 7, 1826.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall5">May 4, 1807</a> to <a href="/courts/ussc/?collection=benches&id=marshall8">February 7, 1826</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
