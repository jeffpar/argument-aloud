---
title: Chief Justice Warren Burger
layout: pane
justice_id: warren_burger
wikipedia_url: https://en.wikipedia.org/wiki/Warren_Burger
years_served: 17.3
days_served: "6,305"
opinions: 258
lone_dissents: 17
vocal_secs: 408568
case_count: 1
first_argument: April 19, 1955
last_argument: April 19, 1955
---
<div style="display:flex; gap:1em;">
<div style="flex:2; min-width:0; overflow:hidden;">
<h1>{{ page.title }}</h1>
<p>Born September 17, 1907. Died June 25, 1995.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=burger1">June 23, 1969</a> to <a href="/courts/ussc/?collection=benches&id=burger7">September 26, 1986</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
