---
title: Chief Justice Melville Fuller
layout: pane
justice_id: melville_fuller
...
<h1>{{ page.title }}</h1>
<p>Born February 11, 1833. Died July 4, 1910.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller1">October 8, 1888</a> to <a href="/courts/ussc/?collection=benches&id=fuller23">July 4, 1910</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
