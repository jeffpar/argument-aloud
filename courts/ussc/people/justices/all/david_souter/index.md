...
layout: pane
justice_id: david_souter
wikipedia_url: https://en.wikipedia.org/wiki/David_Souter
years_served: 18.7
days_served: "6,839"
opinions: 158
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born September 17, 1939. Died May 8, 2025.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rehnquist4">October 9, 1990</a> to <a href="/courts/ussc/?collection=benches&id=roberts2">June 29, 2009</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
