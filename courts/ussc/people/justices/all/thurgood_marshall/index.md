...
wikipedia_url: https://en.wikipedia.org/wiki/Thurgood_Marshall
years_served: 24.0
days_served: "8,766"
opinions: 322
lone_dissents: 56
...
<h1>{{ page.title }}</h1>
<p>Born July 2, 1908. Died January 24, 1993.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren12">October 2, 1967</a> to <a href="/courts/ussc/?collection=benches&id=rehnquist4">October 1, 1991</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
