---
title: Justice Philip Barbour
layout: pane
justice_id: philip_barbour
wikipedia_url: https://en.wikipedia.org/wiki/Philip_Pendleton_Barbour
years_served: 4.8
days_served: "1,751"
opinions: 18
---
...
<h1>{{ page.title }}</h1>
<p>Born May 25, 1783. Died February 25, 1841.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney1">May 12, 1836</a> to <a href="/courts/ussc/?collection=benches&id=taney2">February 25, 1841</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
