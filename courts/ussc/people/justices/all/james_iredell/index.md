---
title: Justice James Iredell
layout: pane
justice_id: james_iredell
wikipedia_url: https://en.wikipedia.org/wiki/James_Iredell
years_served: 9.4
days_served: "3,449"
lone_dissents: 3
---
...
<h1>{{ page.title }}</h1>
<p>Born October 5, 1751. Died October 20, 1799.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay1">May 12, 1790</a> to <a href="/courts/ussc/?collection=benches&id=ellsworth2">October 20, 1799</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
