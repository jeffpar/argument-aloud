---
title: Justice Joseph Story
layout: pane
justice_id: joseph_story
wikipedia_url: https://en.wikipedia.org/wiki/Joseph_Story
years_served: 33.6
days_served: "12,274"
opinions: 267
lone_dissents: 7
...
<h1>{{ page.title }}</h1>
<p>Born September 18, 1779. Died September 10, 1845.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall7">February 3, 1812</a> to <a href="/courts/ussc/?collection=benches&id=taney7">September 10, 1845</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
