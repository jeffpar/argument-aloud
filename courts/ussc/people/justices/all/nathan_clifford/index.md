---
title: Justice Nathan Clifford
layout: pane
justice_id: nathan_clifford
wikipedia_url: https://en.wikipedia.org/wiki/Nathan_Clifford
years_served: 23.5
days_served: "8,587"
opinions: 408
lone_dissents: 41
...
<h1>{{ page.title }}</h1>
<p>Born August 18, 1803. Died July 25, 1881.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney14">January 21, 1858</a> to <a href="/courts/ussc/?collection=benches&id=waite6">July 25, 1881</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
