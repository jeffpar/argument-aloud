---
title: Justice Noah Swayne
layout: pane
justice_id: noah_swayne
wikipedia_url: https://en.wikipedia.org/wiki/Noah_Swayne
years_served: 19.0
days_served: "6,938"
opinions: 346
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born December 7, 1804. Died June 8, 1884.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney17">January 27, 1862</a> to <a href="/courts/ussc/?collection=benches&id=waite5">January 24, 1881</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
