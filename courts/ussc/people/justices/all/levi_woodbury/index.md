---
title: Justice Levi Woodbury
layout: pane
justice_id: levi_woodbury
wikipedia_url: https://en.wikipedia.org/wiki/Levi_Woodbury
years_served: 5.9
days_served: "2,173"
opinions: 42
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Born December 22, 1789. Died September 4, 1851.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney8">September 23, 1845</a> to <a href="/courts/ussc/?collection=benches&id=taney9">September 4, 1851</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
