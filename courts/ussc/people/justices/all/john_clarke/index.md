---
title: Justice John Clarke
layout: pane
justice_id: john_clarke
wikipedia_url: https://en.wikipedia.org/wiki/John_H._Clarke
years_served: 5.9
days_served: "2,171"
opinions: 129
lone_dissents: 20
...
<h1>{{ page.title }}</h1>
<p>Born September 18, 1857. Died March 22, 1945.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=white9">October 9, 1916</a> to <a href="/courts/ussc/?collection=benches&id=taft1">September 18, 1922</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
