---
title: Justice Oliver Holmes
layout: pane
justice_id: oliver_holmes
wikipedia_url: https://en.wikipedia.org/wiki/Oliver_Wendell_Holmes_Jr.
years_served: 29.1
days_served: "10,628"
opinions: 887
lone_dissents: 9
...
<h1>{{ page.title }}</h1>
<p>Born March 8, 1841. Died March 6, 1935.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller17">December 8, 1902</a> to <a href="/courts/ussc/?collection=benches&id=hughes3">January 12, 1932</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
