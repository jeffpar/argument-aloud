---
title: Justice William Woods
layout: pane
justice_id: william_woods
wikipedia_url: https://en.wikipedia.org/wiki/William_Burnham_Woods
years_served: 6.4
days_served: "2,321"
opinions: 162
---
...
<h1>{{ page.title }}</h1>
<p>Born August 3, 1824. Died May 14, 1887.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=waite5">January 5, 1881</a> to <a href="/courts/ussc/?collection=benches&id=waite10">May 14, 1887</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
