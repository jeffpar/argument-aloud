---
title: Justice Rufus Peckham
layout: pane
justice_id: rufus_peckham
wikipedia_url: https://en.wikipedia.org/wiki/Rufus_Wheeler_Peckham
years_served: 13.8
days_served: "5,040"
opinions: 315
lone_dissents: 17
...
<h1>{{ page.title }}</h1>
<p>Born November 8, 1838. Died October 24, 1909.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller13">January 6, 1896</a> to <a href="/courts/ussc/?collection=benches&id=fuller20">October 24, 1909</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
