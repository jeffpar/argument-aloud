---
title: Justice William Strong
layout: pane
justice_id: william_strong
wikipedia_url: https://en.wikipedia.org/wiki/William_Strong_(jurist)
years_served: 10.8
days_served: "3,929"
opinions: 252
lone_dissents: 11
...
<h1>{{ page.title }}</h1>
<p>Born May 6, 1808. Died August 19, 1895.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=chase5">March 14, 1870</a> to <a href="/courts/ussc/?collection=benches&id=waite3">December 14, 1880</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
