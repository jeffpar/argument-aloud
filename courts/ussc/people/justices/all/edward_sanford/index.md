...
layout: pane
justice_id: edward_sanford
wikipedia_url: https://en.wikipedia.org/wiki/Edward_Terry_Sanford
years_served: 7.0
days_served: "2,575"
opinions: 133
---
...
<h1>{{ page.title }}</h1>
<p>Born July 23, 1865. Died March 8, 1930.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taft5">February 19, 1923</a> to <a href="/courts/ussc/?collection=benches&id=hughes1">March 8, 1930</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
