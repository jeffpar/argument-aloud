---
title: Justice James Wilson
layout: pane
justice_id: james_wilson
wikipedia_url: https://en.wikipedia.org/wiki/James_Wilson_(politician)
years_served: 8.9
days_served: "3,243"
opinions: 1
lone_dissents: 1
...
<h1>{{ page.title }}</h1>
<p>Born September 14, 1742. Died August 21, 1798.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay1">October 5, 1789</a> to <a href="/courts/ussc/?collection=benches&id=ellsworth1">August 21, 1798</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
