...
<h1>{{ page.title }}</h1>
<p>Born December 31, 1884. Died April 2, 1980.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=hughes7">January 31, 1938</a> to <a href="/courts/ussc/?collection=benches&id=warren4">February 25, 1957</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
