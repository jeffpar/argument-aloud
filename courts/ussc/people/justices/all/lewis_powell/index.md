---
title: Justice Lewis Powell
layout: pane
justice_id: lewis_powell
wikipedia_url: https://en.wikipedia.org/wiki/Lewis_F._Powell_Jr.
years_served: 15.5
days_served: "5,650"
opinions: 254
lone_dissents: 8
...
<h1>{{ page.title }}</h1>
<p>Born September 19, 1907. Died August 25, 1998.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=burger4">January 7, 1972</a> to <a href="/courts/ussc/?collection=benches&id=rehnquist1">June 26, 1987</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
