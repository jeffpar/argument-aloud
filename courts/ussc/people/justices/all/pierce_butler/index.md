---
title: Justice Pierce Butler
layout: pane
justice_id: pierce_butler
wikipedia_url: https://en.wikipedia.org/wiki/Pierce_Butler_(justice)
years_served: 16.9
days_served: "6,163"
opinions: 327
lone_dissents: 10
...
<h1>{{ page.title }}</h1>
<p>Born March 17, 1866. Died November 16, 1939.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taft4">January 2, 1923</a> to <a href="/courts/ussc/?collection=benches&id=hughes11">November 16, 1939</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
