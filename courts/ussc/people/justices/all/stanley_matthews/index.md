---
title: Justice Stanley Matthews
layout: pane
justice_id: stanley_matthews
...
<h1>{{ page.title }}</h1>
<p>Born July 21, 1824. Died March 22, 1889.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=waite7">May 17, 1881</a> to <a href="/courts/ussc/?collection=benches&id=fuller1">March 22, 1889</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
