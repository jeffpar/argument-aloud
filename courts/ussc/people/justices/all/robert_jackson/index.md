...
<h1>{{ page.title }}</h1>
<p>Born February 13, 1892. Died October 9, 1954.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=stone1">July 11, 1941</a> to <a href="/courts/ussc/?collection=benches&id=warren1">October 9, 1954</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
