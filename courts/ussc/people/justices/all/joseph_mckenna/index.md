...
<h1>{{ page.title }}</h1>
<p>Born August 10, 1843. Died November 21, 1926.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller15">January 26, 1898</a> to <a href="/courts/ussc/?collection=benches&id=taft5">January 5, 1925</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
