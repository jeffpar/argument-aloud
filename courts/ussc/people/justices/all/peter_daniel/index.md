---
title: Justice Peter Daniel
layout: pane
justice_id: peter_daniel
wikipedia_url: https://en.wikipedia.org/wiki/Peter_Daniel
years_served: 18.4
days_served: "6,717"
opinions: 84
lone_dissents: 46
...
<h1>{{ page.title }}</h1>
<p>Born April 24, 1784. Died May 31, 1860.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney4">January 10, 1842</a> to <a href="/courts/ussc/?collection=benches&id=taney14">May 31, 1860</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
