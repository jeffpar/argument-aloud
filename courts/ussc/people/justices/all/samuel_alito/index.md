---
title: Justice Samuel Alito
layout: pane
justice_id: samuel_alito
wikipedia_url: https://en.wikipedia.org/wiki/Samuel_Alito
...
<h1>{{ page.title }}</h1>
<p>Born April 1, 1950.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=roberts2">January 31, 2006</a> to present{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
