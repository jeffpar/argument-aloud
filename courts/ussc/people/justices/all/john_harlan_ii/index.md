...
wikipedia_url: https://en.wikipedia.org/wiki/John_Marshall_Harlan_II
years_served: 16.5
days_served: "6,024"
opinions: 171
lone_dissents: 103
...
<h1>{{ page.title }}</h1>
<p>Born May 20, 1899. Died December 29, 1971.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren3">March 28, 1955</a> to <a href="/courts/ussc/?collection=benches&id=burger2">September 23, 1971</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
