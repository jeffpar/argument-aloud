---
title: Justice Samuel Nelson
layout: pane
justice_id: samuel_nelson
...
<h1>{{ page.title }}</h1>
<p>Born November 10, 1792. Died December 13, 1873.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney7">February 27, 1845</a> to <a href="/courts/ussc/?collection=benches&id=chase6">November 28, 1872</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
