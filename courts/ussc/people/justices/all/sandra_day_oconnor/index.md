---
title: Justice Sandra Day O'Connor
layout: pane
justice_id: sandra_day_oconnor
wikipedia_url: https://en.wikipedia.org/wiki/Sandra_Day_O'Connor
years_served: 24.4
days_served: "8,895"
opinions: 300
lone_dissents: 8
...
<h1>{{ page.title }}</h1>
<p>Born March 26, 1930. Died December 1, 2023.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=burger7">September 25, 1981</a> to <a href="/courts/ussc/?collection=benches&id=roberts1">January 31, 2006</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
