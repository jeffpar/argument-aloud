---
title: Justice William Paterson
layout: pane
justice_id: william_paterson
wikipedia_url: https://en.wikipedia.org/wiki/William_Paterson_(judge)
years_served: 13.5
days_served: "4,930"
opinions: 1
lone_dissents: 1
...
<h1>{{ page.title }}</h1>
<p>Born December 24, 1745. Died September 9, 1806.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay3">March 11, 1793</a> to <a href="/courts/ussc/?collection=benches&id=marshall3">September 9, 1806</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
