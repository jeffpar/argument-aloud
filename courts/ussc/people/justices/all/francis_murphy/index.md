---
title: Justice Francis Murphy
layout: pane
justice_id: francis_murphy
wikipedia_url: https://en.wikipedia.org/wiki/Frank_Murphy
years_served: 9.5
days_served: "3,453"
opinions: 132
lone_dissents: 9
...
<h1>{{ page.title }}</h1>
<p>Born April 13, 1890. Died July 19, 1949.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=hughes13">February 5, 1940</a> to <a href="/courts/ussc/?collection=benches&id=vinson1">July 19, 1949</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
