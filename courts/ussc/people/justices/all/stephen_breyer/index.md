...
layout: pane
justice_id: stephen_breyer
wikipedia_url: https://en.wikipedia.org/wiki/Stephen_Breyer
years_served: 27.9
days_served: "10,194"
opinions: 218
lone_dissents: 13
...
<h1>{{ page.title }}</h1>
<p>Born August 15, 1938.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rehnquist9">August 3, 1994</a> to <a href="/courts/ussc/?collection=benches&id=roberts8">June 30, 2022</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
