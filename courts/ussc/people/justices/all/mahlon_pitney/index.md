---
title: Justice Mahlon Pitney
layout: pane
justice_id: mahlon_pitney
wikipedia_url: https://en.wikipedia.org/wiki/Mahlon_Pitney
years_served: 10.8
days_served: "3,941"
opinions: 251
lone_dissents: 26
...
<h1>{{ page.title }}</h1>
<p>Born February 5, 1858. Died December 9, 1924.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=white4">March 18, 1912</a> to <a href="/courts/ussc/?collection=benches&id=taft3">December 31, 1922</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
