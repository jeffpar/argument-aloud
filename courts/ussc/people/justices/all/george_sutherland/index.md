---
title: Justice George Sutherland
layout: pane
justice_id: george_sutherland
wikipedia_url: https://en.wikipedia.org/wiki/George_Sutherland
years_served: 15.3
days_served: "5,587"
opinions: 288
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Born March 25, 1862. Died July 18, 1942.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taft2">October 2, 1922</a> to <a href="/courts/ussc/?collection=benches&id=hughes6">January 17, 1938</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
