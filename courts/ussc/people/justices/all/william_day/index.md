---
title: Justice William Day
layout: pane
justice_id: william_day
wikipedia_url: https://en.wikipedia.org/wiki/William_R._Day
years_served: 19.7
days_served: "7,197"
opinions: 447
lone_dissents: 6
...
<h1>{{ page.title }}</h1>
<p>Born April 17, 1849. Died July 9, 1923.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller18">March 2, 1903</a> to <a href="/courts/ussc/?collection=benches&id=taft2">November 13, 1922</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
