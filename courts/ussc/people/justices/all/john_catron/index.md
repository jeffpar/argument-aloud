---
title: Justice John Catron
layout: pane
justice_id: john_catron
wikipedia_url: https://en.wikipedia.org/wiki/John_Catron
years_served: 28.1
days_served: "10,257"
opinions: 156
lone_dissents: 13
...
<h1>{{ page.title }}</h1>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney2">May 1, 1837</a> to <a href="/courts/ussc/?collection=benches&id=chase1">May 30, 1865</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
