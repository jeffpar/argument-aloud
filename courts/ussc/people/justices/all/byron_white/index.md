---
title: Justice Byron White
layout: pane
justice_id: byron_white
...
<h1>{{ page.title }}</h1>
<p>Born June 8, 1917. Died April 15, 2002.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren9">April 16, 1962</a> to <a href="/courts/ussc/?collection=benches&id=rehnquist6">June 28, 1993</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
