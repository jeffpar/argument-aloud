---
title: Justice John Blair
layout: pane
justice_id: john_blair
wikipedia_url: https://en.wikipedia.org/wiki/John_Blair_Jr.
years_served: 5.7
days_served: "2,092"
---
...
<h1>{{ page.title }}</h1>
<p>Born April 17, 1732. Died August 31, 1800.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay1">February 2, 1790</a> to <a href="/courts/ussc/?collection=benches&id=rutledge1">October 25, 1795</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
