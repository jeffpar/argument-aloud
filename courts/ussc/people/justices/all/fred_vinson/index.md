---
title: Chief Justice Fred Vinson
layout: pane
justice_id: fred_vinson
wikipedia_url: https://en.wikipedia.org/wiki/Fred_Vinson
years_served: 7.2
days_served: "2,634"
opinions: 77
lone_dissents: 1
...
<h1>{{ page.title }}</h1>
<p>Born January 22, 1890. Died September 8, 1953.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=vinson1">June 24, 1946</a> to <a href="/courts/ussc/?collection=benches&id=vinson2">September 8, 1953</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
