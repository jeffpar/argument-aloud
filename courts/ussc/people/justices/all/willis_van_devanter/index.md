---
title: Justice Willis Van Devanter
layout: pane
justice_id: willis_van_devanter
wikipedia_url: https://en.wikipedia.org/wiki/Willis_Van_Devanter
years_served: 26.4
days_served: "9,648"
opinions: 364
lone_dissents: 3
...
<h1>{{ page.title }}</h1>
<p>Born April 17, 1859. Died February 8, 1941.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=white2">January 3, 1911</a> to <a href="/courts/ussc/?collection=benches&id=hughes5">June 2, 1937</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
