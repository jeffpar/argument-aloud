---
title: Justice William Cushing
layout: pane
justice_id: william_cushing
wikipedia_url: https://en.wikipedia.org/wiki/William_Cushing
years_served: 20.6
days_served: "7,528"
opinions: 4
---
...
<h1>{{ page.title }}</h1>
<p>Born March 1, 1732. Died September 13, 1810.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay1">February 2, 1790</a> to <a href="/courts/ussc/?collection=benches&id=marshall5">September 13, 1810</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
