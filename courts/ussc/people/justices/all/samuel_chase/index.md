---
title: Justice Samuel Chase
layout: pane
justice_id: samuel_chase
wikipedia_url: https://en.wikipedia.org/wiki/Samuel_Chase
years_served: 15.4
days_served: "5,614"
opinions: 1
---
...
<h1>{{ page.title }}</h1>
<p>Born April 17, 1741. Died June 19, 1811.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rutledge2">February 4, 1796</a> to <a href="/courts/ussc/?collection=benches&id=marshall5">June 19, 1811</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
