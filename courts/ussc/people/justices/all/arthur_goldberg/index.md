...
wikipedia_url: https://en.wikipedia.org/wiki/Arthur_Goldberg
years_served: 2.8
days_served: "1,029"
opinions: 36
case_count: 7
...
<h1>{{ page.title }}</h1>
<p>Born August 8, 1908. Died January 19, 1990.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren10">October 1, 1962</a> to <a href="/courts/ussc/?collection=benches&id=warren10">July 25, 1965</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
