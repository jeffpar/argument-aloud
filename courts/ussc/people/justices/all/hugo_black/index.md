...
wikipedia_url: https://en.wikipedia.org/wiki/Hugo_Black
years_served: 34.1
days_served: "12,448"
opinions: 488
lone_dissents: 117
...
<h1>{{ page.title }}</h1>
<p>Born February 27, 1886. Died September 25, 1971.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=hughes6">August 19, 1937</a> to <a href="/courts/ussc/?collection=benches&id=burger2">September 17, 1971</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
