---
title: Justice Bushrod Washington
layout: pane
justice_id: bushrod_washington
wikipedia_url: https://en.wikipedia.org/wiki/Bushrod_Washington
years_served: 31.0
days_served: "11,340"
opinions: 66
lone_dissents: 1
...
<h1>{{ page.title }}</h1>
<p>Born June 5, 1762. Died November 26, 1829.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=ellsworth2">November 9, 1798</a> to <a href="/courts/ussc/?collection=benches&id=marshall12">November 26, 1829</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
