---
title: Chief Justice John Jay
layout: pane
justice_id: john_jay
wikipedia_url: https://en.wikipedia.org/wiki/John_Jay
years_served: 5.7
days_served: "2,080"
opinions: 1
---
...
<h1>{{ page.title }}</h1>
<p>Born December 12, 1745. Died May 17, 1829.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay1">October 19, 1789</a> to <a href="/courts/ussc/?collection=benches&id=jay3">June 29, 1795</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
