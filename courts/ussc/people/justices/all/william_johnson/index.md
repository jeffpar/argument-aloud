---
title: Justice William Johnson
layout: pane
justice_id: william_johnson
wikipedia_url: https://en.wikipedia.org/wiki/William_Johnson_(jurist)
years_served: 30.2
days_served: "11,047"
opinions: 109
lone_dissents: 30
...
<h1>{{ page.title }}</h1>
<p>Born December 27, 1771. Died August 4, 1834.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall3">May 7, 1804</a> to <a href="/courts/ussc/?collection=benches&id=marshall13">August 4, 1834</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
