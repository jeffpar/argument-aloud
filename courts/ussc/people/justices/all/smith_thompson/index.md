---
title: Justice Smith Thompson
layout: pane
justice_id: smith_thompson
wikipedia_url: https://en.wikipedia.org/wiki/Smith_Thompson
years_served: 20.3
days_served: "7,414"
opinions: 84
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Born January 17, 1768. Died December 18, 1843.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall8">September 1, 1823</a> to <a href="/courts/ussc/?collection=benches&id=taney4">December 18, 1843</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
