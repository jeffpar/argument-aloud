...
layout: pane
justice_id: neil_gorsuch
wikipedia_url: https://en.wikipedia.org/wiki/Neil_Gorsuch
...
<h1>{{ page.title }}</h1>
<p>Born August 29, 1967.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=roberts6">April 10, 2017</a> to present{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
