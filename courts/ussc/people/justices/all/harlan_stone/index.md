---
title: Chief Justice Harlan Stone
layout: pane
justice_id: harlan_stone
wikipedia_url: https://en.wikipedia.org/wiki/Harlan_Fiske_Stone
years_served: 21.1
days_served: "7,722"
opinions: 454
lone_dissents: 14
...
<h1>{{ page.title }}</h1>
<p>Born October 11, 1872. Died April 22, 1946.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taft7">March 2, 1925</a> to <a href="/courts/ussc/?collection=benches&id=stone4">April 22, 1946</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
