---
title: Justice Lucius Lamar
layout: pane
justice_id: lucius_lamar
wikipedia_url: https://en.wikipedia.org/wiki/Lucius_Quintus_Cincinnatus_Lamar
years_served: 5.0
days_served: "1,833"
opinions: 101
lone_dissents: 1
...
<h1>{{ page.title }}</h1>
<p>Born September 17, 1825. Died January 23, 1893.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=waite12">January 18, 1888</a> to <a href="/courts/ussc/?collection=benches&id=fuller7">January 23, 1893</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
