...
<h1>{{ page.title }}</h1>
<p>Served from January 18, 1888 to January 23, 1893{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% endif %}.</p>
