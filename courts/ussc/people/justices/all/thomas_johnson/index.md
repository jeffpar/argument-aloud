...
<h1>{{ page.title }}</h1>
<p>Born November 4, 1732. Died October 26, 1819.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=jay1">September 19, 1791</a> to <a href="/courts/ussc/?collection=benches&id=jay1">January 16, 1793</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
