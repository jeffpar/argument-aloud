---
title: Chief Justice Roger Taney
layout: pane
justice_id: roger_taney
...
<h1>{{ page.title }}</h1>
<p>Born March 17, 1777. Died October 12, 1864.</p>
<p>Served from March 28, 1836 to <a href="/courts/ussc/?collection=benches&id=taney19">October 12, 1864</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
