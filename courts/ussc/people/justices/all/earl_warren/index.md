...
<h1>{{ page.title }}</h1>
<p>Born March 19, 1891. Died July 9, 1974.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren1">October 5, 1953</a> to <a href="/courts/ussc/?collection=benches&id=warren13">June 23, 1969</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
