...
layout: pane
justice_id: clarence_thomas
wikipedia_url: https://en.wikipedia.org/wiki/Clarence_Thomas
date_start: 1991-10-23
opinions: 265
lone_dissents: 55
vocal_secs: 43547
---
...
<h1>{{ page.title }}</h1>
<p>Born June 23, 1948.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rehnquist6">October 23, 1991</a> to present{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
