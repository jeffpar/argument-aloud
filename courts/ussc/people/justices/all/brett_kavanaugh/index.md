...
vocal_secs: 92714
case_count: 1
first_argument: June 8, 1998
last_argument: June 8, 1998
---
<div style="display:flex; gap:1em;">
<div style="flex:2; min-width:0; overflow:hidden;">
<h1>{{ page.title }}</h1>
<p>Born February 12, 1965.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=roberts7">October 6, 2018</a> to present{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
