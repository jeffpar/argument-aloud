---
title: Justice Stephen Field
layout: pane
justice_id: stephen_field
...
<h1>{{ page.title }}</h1>
<p>Born November 4, 1816. Died April 9, 1899.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney19">May 20, 1863</a> to <a href="/courts/ussc/?collection=benches&id=fuller13">December 1, 1897</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
