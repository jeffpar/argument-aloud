---
title: Justice Harry Blackmun
layout: pane
justice_id: harry_blackmun
wikipedia_url: https://en.wikipedia.org/wiki/Harry_Blackmun
years_served: 24.2
days_served: "8,822"
opinions: 314
lone_dissents: 27
...
<h1>{{ page.title }}</h1>
<p>Born November 12, 1908. Died March 4, 1999.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=burger2">June 9, 1970</a> to <a href="/courts/ussc/?collection=benches&id=rehnquist8">August 3, 1994</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
