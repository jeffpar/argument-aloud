...
<h1>{{ page.title }}</h1>
<p>Served from February 15, 1790 to March 5, 1791 and from August 12, 1795 to December 28, 1795{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
