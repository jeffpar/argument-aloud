---
title: Chief Justice John Rutledge
layout: pane
justice_id: john_rutledge
wikipedia_url: https://en.wikipedia.org/wiki/John_Rutledge
years_served: 1.4
days_served: "523"
---
...
<h1>{{ page.title }}</h1>
<p>Born September 17, 1739. Died July 18, 1800.</p>
<p>Served from February 15, 1790 to March 5, 1791 and from August 12, 1795 to <a href="/courts/ussc/?collection=benches&id=rutledge1">December 28, 1795</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
