...
layout: pane
justice_id: anthony_kennedy
wikipedia_url: https://en.wikipedia.org/wiki/Anthony_Kennedy
years_served: 30.5
days_served: "11,122"
opinions: 276
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Born July 23, 1936.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rehnquist3">February 18, 1988</a> to <a href="/courts/ussc/?collection=benches&id=roberts6">July 31, 2018</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
