...
wikipedia_url: https://en.wikipedia.org/wiki/Oliver_Ellsworth
years_served: 4.8
days_served: "1,743"
opinions: 10
---
...
<h1>{{ page.title }}</h1>
<p>Born April 29, 1745. Died November 26, 1807.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=ellsworth1">March 8, 1796</a> to <a href="/courts/ussc/?collection=benches&id=ellsworth4">December 15, 1800</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
