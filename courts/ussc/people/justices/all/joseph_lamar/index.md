---
title: Justice Joseph Lamar
layout: pane
justice_id: joseph_lamar
wikipedia_url: https://en.wikipedia.org/wiki/Joseph_Rucker_Lamar
years_served: 5.0
days_served: "1,826"
opinions: 113
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born October 14, 1857. Died January 2, 1916.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=white2">January 3, 1911</a> to <a href="/courts/ussc/?collection=benches&id=white5">January 2, 1916</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
