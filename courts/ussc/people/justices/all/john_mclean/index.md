...
<h1>{{ page.title }}</h1>
<p>Born March 11, 1785. Died April 4, 1861.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall12">March 12, 1829</a> to <a href="/courts/ussc/?collection=benches&id=taney15">April 4, 1861</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
