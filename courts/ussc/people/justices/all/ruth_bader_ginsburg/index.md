...
layout: pane
justice_id: ruth_bader_ginsburg
...
<h1>{{ page.title }}</h1>
<p>Born March 15, 1933. Died September 18, 2020.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=rehnquist8">August 10, 1993</a> to <a href="/courts/ussc/?collection=benches&id=roberts7">September 18, 2020</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
