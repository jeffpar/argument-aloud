---
title: Chief Justice Salmon Chase
layout: pane
justice_id: salmon_chase
wikipedia_url: https://en.wikipedia.org/wiki/Salmon_Chase
years_served: 8.4
days_served: "3,066"
opinions: 218
lone_dissents: 6
...
<h1>{{ page.title }}</h1>
<p>Born January 13, 1808. Died May 7, 1873.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=chase1">December 15, 1864</a> to <a href="/courts/ussc/?collection=benches&id=chase8">May 7, 1873</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
