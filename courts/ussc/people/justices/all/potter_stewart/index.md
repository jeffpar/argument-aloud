...
layout: pane
justice_id: potter_stewart
wikipedia_url: https://en.wikipedia.org/wiki/Potter_Stewart
years_served: 22.7
days_served: "8,299"
opinions: 314
lone_dissents: 31
...
<h1>{{ page.title }}</h1>
<p>Born January 23, 1915. Died December 7, 1985.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren7">October 14, 1958</a> to <a href="/courts/ussc/?collection=benches&id=burger6">July 3, 1981</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
