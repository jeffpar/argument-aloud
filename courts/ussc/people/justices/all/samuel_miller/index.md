---
title: Justice Samuel Miller
layout: pane
justice_id: samuel_miller
wikipedia_url: https://en.wikipedia.org/wiki/Samuel_Freeman_Miller
years_served: 28.2
days_served: "10,312"
opinions: 625
lone_dissents: 44
...
<h1>{{ page.title }}</h1>
<p>Born April 5, 1816. Died October 13, 1890.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney18">July 21, 1862</a> to <a href="/courts/ussc/?collection=benches&id=fuller3">October 13, 1890</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
