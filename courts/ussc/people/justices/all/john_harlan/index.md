---
title: Justice John Harlan
layout: pane
justice_id: john_harlan
wikipedia_url: https://en.wikipedia.org/wiki/John_Marshall_Harlan
years_served: 33.8
days_served: "12,361"
opinions: 744
lone_dissents: 134
...
<h1>{{ page.title }}</h1>
<p>Born June 1, 1833. Died October 14, 1911.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=waite3">December 10, 1877</a> to <a href="/courts/ussc/?collection=benches&id=white2">October 14, 1911</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
