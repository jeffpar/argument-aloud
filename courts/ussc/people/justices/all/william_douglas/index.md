---
title: Justice William Douglas
layout: pane
justice_id: william_douglas
wikipedia_url: https://en.wikipedia.org/wiki/William_O._Douglas
years_served: 36.6
days_served: "13,359"
opinions: 537
lone_dissents: 229
...
<h1>{{ page.title }}</h1>
<p>Born October 16, 1898. Died January 19, 1980.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=hughes11">April 17, 1939</a> to <a href="/courts/ussc/?collection=benches&id=burger4">November 12, 1975</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
