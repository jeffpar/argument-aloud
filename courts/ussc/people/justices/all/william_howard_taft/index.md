...
<h1>{{ page.title }}</h1>
<p>Born September 15, 1857. Died March 8, 1930.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taft1">July 11, 1921</a> to <a href="/courts/ussc/?collection=benches&id=taft7">February 3, 1930</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
