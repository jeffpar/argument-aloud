...
layout: pane
justice_id: henry_livingston
wikipedia_url: https://en.wikipedia.org/wiki/Brockholst_Livingston
years_served: 16.2
days_served: "5,902"
opinions: 39
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born November 25, 1757. Died March 18, 1823.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=marshall4">January 20, 1807</a> to <a href="/courts/ussc/?collection=benches&id=marshall7">March 18, 1823</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
