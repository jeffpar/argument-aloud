---
title: Justice Owen Roberts
layout: pane
justice_id: owen_roberts
wikipedia_url: https://en.wikipedia.org/wiki/Owen_Roberts
years_served: 15.2
days_served: "5,539"
opinions: 298
lone_dissents: 51
...
<h1>{{ page.title }}</h1>
<p>Born May 2, 1875. Died May 17, 1955.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=hughes3">June 2, 1930</a> to <a href="/courts/ussc/?collection=benches&id=stone3">July 31, 1945</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
