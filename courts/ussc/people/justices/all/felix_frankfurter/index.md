---
title: Justice Felix Frankfurter
layout: pane
justice_id: felix_frankfurter
...
<h1>{{ page.title }}</h1>
<p>Born November 15, 1882. Died February 22, 1965.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=hughes9">January 30, 1939</a> to <a href="/courts/ussc/?collection=benches&id=warren9">August 28, 1962</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
