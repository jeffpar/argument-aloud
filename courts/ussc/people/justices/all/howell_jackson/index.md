---
title: Justice Howell Jackson
layout: pane
justice_id: howell_jackson
wikipedia_url: https://en.wikipedia.org/wiki/Howell_Edmunds_Jackson
years_served: 2.4
days_served: "888"
opinions: 47
---
...
<h1>{{ page.title }}</h1>
<p>Born April 8, 1832. Died August 8, 1895.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=fuller9">March 4, 1893</a> to <a href="/courts/ussc/?collection=benches&id=fuller11">August 8, 1895</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
