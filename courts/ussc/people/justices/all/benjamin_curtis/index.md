---
title: Justice Benjamin Curtis
layout: pane
justice_id: benjamin_curtis
wikipedia_url: https://en.wikipedia.org/wiki/Benjamin_Curtis
years_served: 6.0
days_served: "2,183"
opinions: 52
lone_dissents: 1
...
<h1>{{ page.title }}</h1>
<p>Born November 4, 1809. Died September 15, 1874.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney10">October 10, 1851</a> to <a href="/courts/ussc/?collection=benches&id=taney12">September 30, 1857</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
