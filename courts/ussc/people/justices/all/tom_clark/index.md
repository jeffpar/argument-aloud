---
title: Justice Tom Clark
layout: pane
justice_id: tom_clark
wikipedia_url: https://en.wikipedia.org/wiki/Tom_C._Clark
years_served: 17.8
days_served: "6,502"
opinions: 216
lone_dissents: 17
...
<h1>{{ page.title }}</h1>
<p>Born September 23, 1899. Died June 13, 1977.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=vinson2">August 24, 1949</a> to <a href="/courts/ussc/?collection=benches&id=warren11">June 12, 1967</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
