---
title: Justice James Byrnes
layout: pane
justice_id: james_byrnes
wikipedia_url: https://en.wikipedia.org/wiki/James_F._Byrnes
years_served: 1.2
days_served: "453"
opinions: 16
---
...
<h1>{{ page.title }}</h1>
<p>Born May 2, 1882. Died April 9, 1972.</p>
<p>Served from July 8, 1941 to <a href="/courts/ussc/?collection=benches&id=stone1">October 3, 1942</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
