...
wikipedia_url: https://en.wikipedia.org/wiki/Charles_Whittaker
years_served: 5.0
days_served: "1,833"
opinions: 42
lone_dissents: 12
...
<h1>{{ page.title }}</h1>
<p>Born February 22, 1901. Died November 26, 1973.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=warren6">March 25, 1957</a> to <a href="/courts/ussc/?collection=benches&id=warren7">March 31, 1962</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
