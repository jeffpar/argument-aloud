---
title: Justice Sherman Minton
layout: pane
justice_id: sherman_minton
wikipedia_url: https://en.wikipedia.org/wiki/Sherman_Minton
years_served: 7.0
days_served: "2,561"
opinions: 64
lone_dissents: 2
...
<h1>{{ page.title }}</h1>
<p>Born October 20, 1890. Died April 9, 1965.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=vinson2">October 12, 1949</a> to <a href="/courts/ussc/?collection=benches&id=warren3">October 15, 1956</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
