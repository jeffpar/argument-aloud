---
title: Chief Justice Morrison Waite
layout: pane
justice_id: morrison_waite
wikipedia_url: https://en.wikipedia.org/wiki/Morrison_Waite
years_served: 14.1
days_served: "5,134"
opinions: 1000
lone_dissents: 12
...
<h1>{{ page.title }}</h1>
<p>Born November 29, 1816. Died March 23, 1888.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=waite1">March 4, 1874</a> to <a href="/courts/ussc/?collection=benches&id=waite12">March 23, 1888</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
