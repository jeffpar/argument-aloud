...
layout: pane
justice_id: john_paul_stevens
wikipedia_url: https://en.wikipedia.org/wiki/John_Paul_Stevens
years_served: 34.5
days_served: "12,612"
opinions: 397
lone_dissents: 162
...
<h1>{{ page.title }}</h1>
<p>Born April 20, 1920. Died July 16, 2019.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=burger6">December 19, 1975</a> to <a href="/courts/ussc/?collection=benches&id=roberts3">June 29, 2010</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
