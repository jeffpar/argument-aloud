---
title: Justice David Davis
layout: pane
justice_id: david_davis
wikipedia_url: https://en.wikipedia.org/wiki/David_Davis_(judge)
years_served: 14.2
days_served: "5,199"
opinions: 196
lone_dissents: 5
...
<h1>{{ page.title }}</h1>
<p>Born March 9, 1815. Died June 26, 1886.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=taney18">December 10, 1862</a> to <a href="/courts/ussc/?collection=benches&id=waite1">March 4, 1877</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
