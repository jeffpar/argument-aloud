---
title: Justice Ward Hunt
layout: pane
justice_id: ward_hunt
wikipedia_url: https://en.wikipedia.org/wiki/Ward_Hunt
years_served: 9.1
days_served: "3,306"
opinions: 147
lone_dissents: 2
...
<h1>{{ page.title }}</h1>
<p>Born June 14, 1810. Died March 24, 1886.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=chase8">January 9, 1873</a> to <a href="/courts/ussc/?collection=benches&id=waite8">January 27, 1882</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
