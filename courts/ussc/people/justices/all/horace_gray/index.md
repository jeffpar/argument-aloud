---
title: Justice Horace Gray
layout: pane
justice_id: horace_gray
wikipedia_url: https://en.wikipedia.org/wiki/Horace_Gray
years_served: 20.7
days_served: "7,554"
opinions: 443
lone_dissents: 4
...
<h1>{{ page.title }}</h1>
<p>Born March 24, 1828. Died September 15, 1902.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=waite8">January 9, 1882</a> to <a href="/courts/ussc/?collection=benches&id=fuller15">September 15, 1902</a>{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
