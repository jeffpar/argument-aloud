---
title: Justice Sonia Sotomayor
layout: pane
justice_id: sonia_sotomayor
wikipedia_url: https://en.wikipedia.org/wiki/Sonia_Sotomayor
...
<h1>{{ page.title }}</h1>
<p>Born June 25, 1954.</p>
<p>Served from <a href="/courts/ussc/?collection=benches&id=roberts3">August 8, 2009</a> to present{% if page.years_served %}{% assign yr_str = page.years_served | append: "" | remove: ".0" %} ({{ yr_str }} year{% unless yr_str == "1" %}s{% endunless %} or {{ page.days_served }} days){% elsif page.date_start %} <span id="jp-dur"></span>{% endif %}.</p>
