...
This site stores its data in JSON files rather than spreadsheets, but as a convenience for those who still prefer them, we continue to automatically generate the following spreadsheet:
...
It's worth noting when discussing advocate appearances, the unit of measure is generally "argument", not "case", because sometimes a case must be reargued once or even twice.  Conversely, sometimes an attorney will present arguments for multiple cases at the same time (for example, as an *amicus curiae* or friend of the Court), which we count (and which, as far as we can tell, the Court always counts) as a single argument.
...
However, 24 *cases* are attributed to her, because [10 East 40th St. Bldg v. Callus (No. 820)](/courts/ussc/?collection=women_advocates&id=bessie_margolin&term=1944-10&case=820) was decided separately from [Borden v. Borella (No. 688)](/courts/ussc/?collection=women_advocates&id=bessie_margolin&term=1944-10&case=688).  With respect to her *arguments* in those two cases, the [1944 U.S. Supreme Court Journal](https://www.supremecourt.gov/pdfs/journals/scannedjournals/1944_journal.pdf#page=220) does not mention her in the context of No. 688; it says only:
...
While one could certainly make the case that she made *two* arguments, it's safer to say only that she argued both cases in a *single* argument.  This approach also allows our data collection efforts to focus on data that is indisputable and consistent for all advocates, leaving the finer details for another day. [[1](#footnote-1)]

When an advocate makes separate arguments in separate cases, the Journals tend to be clearer.  For example, if you look at Nos. 554 and 555 in the [1942 U.S. Supreme Court Journal](https://www.supremecourt.gov/pdfs/journals/scannedjournals/1942_journal.pdf#page=161), you'll see two non-consolidated, consecutively-argued cases, and Solicitor General Fahy is listed separately in each case, so we attribute two arguments to him.  Ultimately, both arguments are listed under *one* case, because the cases were decided together (see [319 U.S. 190](https://tile.loc.gov/storage-services/service/ll/usrep/usrep319/usrep319190/usrep319190.pdf)), but that has no bearing on the number of arguments.

---

<p id="footnote-1" class="footnote-label">Footnote 1</p>

In the [Journal of Supreme Court History, Vol. 37, No. 1, at 58 (2012)](https://supremecourthistory.org/wp-content/uploads/2025/02/Volume-37-Number-1-2012.pdf#page=60), Marlene Trestman explains that Bessie Margolin was initially only going to argue No. 820, but was asked to also argue No. 688 at the last minute.  However, it remains unclear how many arguments the Supreme Court itself would attribute to her appearance, and more to the point, how we should count all other such appearances, given that we don't generally have the benefit of additional context outside the Court's own records.

And while it's worth noting that Nos. 688 and 820 were not consolidated for argument by the Court, that doesn't change our interpretation of the data, because as we've noted above, when that happens, the Court generally lists each person's argument in each case, even if that means mentioning the same person multiple times -- and in Nos. 688 and 820, the Court did not do that.
