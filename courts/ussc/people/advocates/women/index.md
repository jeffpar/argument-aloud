...
This site does not rely on external spreadsheets, but as a convenience for those who still prefer them, we will continue to automatically generate one:
...
However, 24 *cases* are attributed to her, because [10 East 40th St. Bldg v. Callus (No. 820)](/courts/ussc/?collection=women_advocates&id=bessie_margolin&term=1944-10&case=820) was decided separately from [Borden v. Borella (No. 688)](/courts/ussc/?collection=women_advocates&id=bessie_margolin&term=1944-10&case=688).  With respect to her *arguments* in those two cases, the [1944 U.S. Supreme Court Journal](https://www.supremecourt.gov/pdfs/journals/scannedjournals/1944_journal.pdf#page=220) does not mention her in the context of No. 688. It says only this:
...
So while one could certainly make the case that she made *two* arguments, it's safer to say only that she argued both cases during a single appearance.  This approach also allows our data collection efforts to focus on data that is indisputable and consistent for all advocates (ie, number of appearances), leaving the details for another day. [[1](#footnote-1)]

And since we have no general basis for distinguishing *appearances* from *arguments*, we tend to use the terms interchangeably.  For example, if you look at Nos. 554 and 555 in the [1942 U.S. Supreme Court Journal](https://www.supremecourt.gov/pdfs/journals/scannedjournals/1942_journal.pdf#page=161), you'll see two non-consolidated, consecutively-argued cases, but Solicitor General Fahy is listed in each case, making it clear that he made separate *appearances* in each of the two cases, and thus two *arguments*.  On the other hand, the cases were ultimately decided together, so only one *case* is attributed to him (see [319 U.S. 190](https://tile.loc.gov/storage-services/service/ll/usrep/usrep319/usrep319190/usrep319190.pdf)).
