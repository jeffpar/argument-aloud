...
cards:
  - title: "Missing Audio"
    desc: "Cases that <em>should</em> have audio (from October 1955 or later) but which is missing or misfiled."
  ...
  - title: "Unidentified Speakers"
    desc: "Audio files that have aligned transcripts with unknown speakers (see the <a href='https://www.oyez.org'>Oyez Project</a>)."
    href: "/courts/ussc/?collection=audits&id=unidentified-speakers"
  - title: "Missing LOC Opinions"
    desc: "Cases missing an opinion in the Library of Congress <a href='https://www.loc.gov/collections/united-states-reports/'>U.S. Reports</a> Collection."
  ...
  - title: "All Warnings"
    desc: "Cases with warnings, either due to problems in the <a href='https://scdb.la.psu.edu'>Supreme Court Database</a> or in <a href='https://www.loc.gov/collections/united-states-reports/'>U.S. Reports</a>."
