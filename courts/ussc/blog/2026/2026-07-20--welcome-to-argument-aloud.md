...
The [On This Day](/courts/ussc/?collection=on-this-day) feature isn't actually part of the Search function, but it's another type of case-related search the site can perform.  It allows you to randomly selects a case that was either argued or decided on the current month and day at some previous point in the Court's history.
