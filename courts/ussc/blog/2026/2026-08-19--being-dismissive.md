...
That case underscores an important point about DIGs: there is *always* an underlying reason for a DIG, but for Court to articulate that reason only when it wants to (eg, to admonish the parties), and to otherwise avoid admitting any mistakes of its own or simply helping the parties understand what criteria they failed to satisfy, seems rather self-serving.
