...
That case underscores an important point about DIGs: there is *always* an underlying reason for a DIG, but for the Court to articulate that reason *only* when it wants to (eg, to admonish the parties), and to otherwise avoid admitting any mistakes of its own, even when that would help everyone understand what threshold was not reached, seems rather a self-serving lack of transparency.
