---
title: "Being Dismissive"
layout: pane
date: 2026-08-19
permalink: /courts/ussc/blog/2026/being-dismissive/
---
...
We recently added some new filtering options to the Terms list, including a "DIGs" checkbox that filters the list down to just those cases that have been "Dismissed as Improvidently Granted", aka "DIG'ed".

As [Wikipedia](https://en.wikipedia.org/wiki/Dismissed_as_improvidently_granted) explains:

> The Supreme Court normally DIGs a case through a *per curiam decision* [unsigned opinion], usually without giving reasons, but rather issuing a one-line decision: "***The writ of certiorari is dismissed as improvidently granted.***" However, justices sometimes file separate opinions, and the opinion of the court may instead give reasons for the DIG.
...
With that in mind, here are all the cases the 2006 paper cites that we consider only [Partial DIGs](/courts/ussc/?filter=partial_digs):

- [Wolf v. Weinstein (1963)](/courts/ussc/?term=1962-10&case=70)
- [Mishkin v. New York (1966)](/courts/ussc/?term=1965-10&case=49)
- [Whitus v. Georgia (1967)](/courts/ussc/?term=1966-10&case=650)
- [Gilbert v. California (1967)](/courts/ussc/?term=1966-10&case=223)
- [United States v. Nixon (1974)](/courts/ussc/?term=1973-10&case=73-1766)
- [Walter v. United States (1980)](/courts/ussc/?term=1979-10&case=79-67)
- [National Labor Relations Board v. Hendricks County Rural Electric Membership Corporation (1981)](/courts/ussc/?term=1981-10&case=80-885)
- [Zipes v. Trans World Airlines, Inc. (1982)](/courts/ussc/?term=1981-10&case=78-1545)
- [Allied Tube & Conduit Corporation v. Indian Head, Inc. (1988)](/courts/ussc/?term=1987-10&case=87-157)
- [Parker v. Dugger (1991)](/courts/ussc/?term=1990-10&case=89-5961)
...
However, you can choose either or both criteria when focusing on DIGs: simply check both [DIGs](/courts/ussc/?filter=digs) and [Partial DIGs](/courts/ussc/?filter=partial_digs) to obtain a combined list.

Finally, there are cases like these, the "dregs of the DIGs", which were "dismissed as improvidently granted" without any action (ie, no arguments and no statements from any of the Justices):

- Hooper v. Bennett (1961), 364 U.S. 807
- Romontio v. United States (1971), 402 U.S. 903
- N.Y. State Parole Bd. v. Coralluzzo (1978), 435 U.S. 912
- Montgomery v. Century Laminating, Ltd. (1979), 444 U.S. 987
- Poythress v. Duncan (1982), 459 U.S. 1012
- Eicke v. Eicke (1983), 459 U.S. 1139
- Roadway Express, Inc. v. Warren (1983), 464 U.S. 988
- Richards v. Jefferson County (1996), 516 U.S. 1167
- Ogbomon v. United States (1997), 519 U.S. 1073
...
It's worth mentioning that in at least one of those examples, *N.Y. State Parole Bd. v. Coralluzzo*, it was noted that Justices White and Rehnquist dissented from the dismissal, but since no further explanation was provided, the case is still effectively outside the bounds of our collection.

There are also some cases that one might think of as a DIG "sub-species", where the dissent *strenuously* argued (unsuccessfully) that the case *should* have been DIG'ed.  For example:

- [McWilliams v. Dunn (2017)](/courts/ussc/?term=2016-10&case=16-5294)

In the *McWilliams v. Dunn* dissent, other DIGs are cited, including yet another DIG which (for the same reasons already stated above) is not part of our collection:
...
That case underscores an important point about DIGs: there is *always* an underlying reason for a DIG, but for the Court to articulate that reason *only* when it wants to (eg, to admonish the parties), and to otherwise avoid admitting any mistakes or clarifying what conditions were not satisfied, seems rather self-serving.

At the end of the day, dismissals without explanation are just a variation of denials, which the Court does by the thousands every year, also without any explanation, so there is a stubborn consistency to its behavior.
