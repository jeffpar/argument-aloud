...
---
# WA Supreme Court Blog

{%- assign blog_posts = site.pages | where_exp: "p", "p.url contains '/courts/wasc/blog/'" | where_exp: "p", "p.date" | sort: "date" | reverse %}
...
{%- for post in blog_posts %}
  ...
  {%- assign blog_href = "/courts/wasc/?link=" | append: blog_path %}
