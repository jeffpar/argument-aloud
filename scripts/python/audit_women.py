...
_SPEAKERS_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'speakers.json')
_DATES_CSV_PATH = os.path.join(BASE_DIR, 'data', 'aa', 'ussc_dates.csv')
