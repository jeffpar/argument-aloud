...
Every U.S. Supreme Court case usually ends with an opinion, but fully understanding that opinion means understanding how the case started and what arguments were made.  This website helps bring those threads together.
...
Finally, some weeks or months later, an opinion is issued, unless the Court rescheduled the case for re-argument, dismissed the case as improperly granted or moot, or simply could not reach a decision (if an even number of Justices were deadlocked).
